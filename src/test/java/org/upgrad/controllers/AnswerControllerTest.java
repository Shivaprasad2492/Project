...
//
//    @Test
//    public void getAllAnswersByLikesWithAuthentication() throws Exception{
//        User user = new User();
//        user.setUserName("upgrad");
//        user.setRole("user");
//        session = new MockHttpSession();
...
//        Answer answer = new Answer();
//        answer.setId(2);
//        answer.setAns("This is an answer to REST acrchitecture.");
//        Map<Answer,Integer> maps = new HashMap<>();
//        maps.put(answer,2);
//        Question question = new Question();
//        question.setId(3);
//        answer.setQuestion(question);
//        Iterable<Map<Answer,Integer>> answers = singleton(maps);
//        Mockito.when(answerService.getAllAnswersByLikes(3)).thenReturn(answers);
//        String url = "/api/answer/all/likes/3";
//        mvc.perform(get(url).session(session)
//                .contentType(MediaType.asMediaType(APPLICATION_JSON)))
//                .andExpect(status().is2xxSuccessful())
