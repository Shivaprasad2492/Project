...
//        answer.setUser(user);
//        answer.setId(1);
//        Mockito.when(likeService.getUserId(answer.getId(),user.getId())).thenReturn(null);
//        String url = "/api/unlike/1";
//        mvc.perform(delete(url).session(session)
//                .param("answerId",answerId))
//                .andExpect(status().is4xxClientError())
...
//        answer.setUser(user);
//        answer.setId(1);
//        Mockito.when(likeService.getUserId(answer.getId(),user.getId())).thenReturn(user.getId());
//        String url = "/api/unlike/1";
//        mvc.perform(delete(url).session(session)
//                .param("answerId",answerId))
//                .andExpect(status().is2xxSuccessful())
...
//
//    @Test
//    public void removeLikesWithAuthByAdmin() throws Exception{
//        User user = new User();
//        user.setUserName("upgrad");
//        user.setRole("admin");
//        session = new MockHttpSession();
...
//        String answerId ="1";
//        user.setId(3);
//        Mockito.when(answerService.findUserIdfromAnswer(1)).thenReturn(2);
//        String url = "/api/unlike/1";
//        mvc.perform(delete(url).session(session)
//                .param("answerId",answerId))
//                .andExpect(status().is2xxSuccessful())
...
//
//    @Test
//    public void removeFollowWithoutAuth() throws Exception{
//        User user = new User();
//        user.setUserName("upgrad");
//        user.setRole("user");
//        session = new MockHttpSession();
