...
//
//    @Test
//    public void getUserProfileWithoutLogin() throws Exception{
//        session = new MockHttpSession();
//        session.setAttribute("currUser", null);
//        String url = "/api/user/userprofile/1";
...
//
//    @Test
//    public void getNonExistingUserProfileWithLogin() throws Exception{
//        User user = new User();
//        user.setUserName("upgrad");
//        user.setRole("user");
//        user.setId(2);
//        session = new MockHttpSession();
//        session.setAttribute("currUser", user);
//        given(userProfileService.getUser(1)).willReturn(null);
//        String url = "/api/user/userprofile/1";
//        mvc.perform(get(url).session(session))
//                .andExpect(status().is4xxClientError())
//                .andExpect(content().string(Matchers.containsString("User Profile not found!")));
//    }
//
//    @Test
//    public void getUserProfileWithLogin() throws Exception{
//        User user = new User();
//        user.setUserName("upgrad");
//        user.setRole("user");
//        user.setId(2);
...
//        userProfile.setId(2);
//        userProfile.setFirstName("software");
//        List<UserProfile> userProfiles = singletonList(userProfile);
//        session = new MockHttpSession();
//        session.setAttribute("currUser", user);
//        given(userProfileService.getUser(user.getId())).willReturn(userProfile);
//        String url = "/api/user/userprofile/2";
//        mvc.perform(get(url).session(session)
//                .contentType(MediaType.asMediaType(APPLICATION_JSON)))
//                .andExpect(status().is2xxSuccessful())
//                .andExpect(jsonPath("$.firstName", Matchers.is(userProfile.getFirstName())));
//    }
//
//    @Test
